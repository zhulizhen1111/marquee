...
export default {
  ...
  mounted () {
    ...
    this.$nextTick(() => {
      this.textWidth = document.querySelector(`.sgy-marquee[data-guid="${this.guid}"]`).scrollWidth
      this.offsetWidth = document.querySelector(`.sgy-marquee[data-guid="${this.guid}"]`).offsetWidth
      this.initCss()
    })
  },
  methods: {
